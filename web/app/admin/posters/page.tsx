  ...
  if (!email) {
    return (
      <main className="mx-auto max-w-[440px] px-5 pt-20 text-center">
        ...
        <Link href="/login" className="mt-5 inline-block rounded-full bg-[var(--brand)] px-5 py-2.5 text-[15px] font-medium text-white">
          התחברות
        </Link>
      </main>
    );
  ...
  return (
    <main className="mx-auto w-full max-w-5xl px-5 pb-24 pt-8 lg:px-8">
      <header className="mb-6">
        ...
        <p className="mt-1 text-[15px] text-[var(--text-2)]">
          בחרו תמונה אמיתית לכל עיר — היא <b>מוצגת באתר מיד</b> עם הבחירה. (אופציונלי: <code>finalize_posters.py</code> יוצר עותקים סטטיים מותאמים ומסמן «מותאם».)
        </p>
      </header>
